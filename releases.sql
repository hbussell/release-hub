...
INSERT INTO `Project` VALUES (1,'alfred','/var/docroot/release-hub/config/projects/alfred/actions.yml','git@github.com:fclimited/alfred.git','/var/docroot/release-hub/config/projects/alfred/options.yml'),(2,'fcl-corporate','/var/docroot/release-hub/config/projects/fcl-corporate/actions.yml','','gitUrl: git@github.com:fclimited/fcl-corporate.git\nremote: origin\nreleaseBranch: \"{{ release }}\"\n');
...
INSERT INTO `ReleaseVersion` VALUES (1,1,1,'test','2014-05-04 17:38:33',NULL,'STATUS_PENDING',NULL,'deployments-2.0','/var/docroot/release-hub/config/projects/alfred/actions.yml','','/var/docroot/release-hub/config/projects/alfred/options.yml'),(3,1,2,'hell-razer-1.1','2014-05-11 20:14:11',NULL,'STATUS_PENDING','2014-05-09 00:00:00','drupal-core/feature/DRU-261-media-browser\r\ndrupal-core/feature/DRU-1003-cheapest-product-fix-v2','check:\n - /var/docroot/release-hub/bin/createBranch.sh {{ checkout }} {{ releaseBranch }} {{ remote }} \n - /var/docroot/release-hub/bin/merge.sh {{ checkout }} {{ branch }} {{ releaseBranch }} {{ remote }} --dry:\n   - each branch\n - test feature branches\n - check ticket status\n - extra something\nrelease:\n - create release branch\n - merge feature branches\n - deploy release branch to test\n - sync dbs and files from prod to test\n - notifications\nregression:\n - regression test release  \npublish:\n','','gitUrl: git@github.com:fclimited/fcl-corporate.git\nremote: origin\nreleaseBranch: \"{{ release }}\"\n');
...
-- Dump completed on 2014-05-11 19:35:32
